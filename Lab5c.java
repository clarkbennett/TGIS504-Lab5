package com.example.clark.lab5clocation;
...
public class Lab5c extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lab5c);
     ...
     * we just add a marker for UW Tacoma.
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // Add a marker in Tacoma, WA and move the camera
        LatLng tacoma= new LatLng(47.2446, -122.4376);
        mMap.addMarker(new MarkerOptions().position(tacoma).title("UW Tacoma Campus"));
